...
class DivarContest:
    ...
    def extract_text(self, image_path):
        ...
        results = self.ocr_reader.readtext(image_bytes, detail=0)
        return " ".join(results)
    
    def capture_the_flag(self, question):
        messages = [
                { "role": "system", "content": "You are a helpful assistant that should solve the puzzles. When solving puzzle use extract_text if needed to fetch text from image." },
